        ...
        @if (auth()->user()->hasRole('admin'))
            ...
            <li>
                <button type="button"
                    ...
                    <span class="flex-1 ms-3 text-left whitespace-nowrap">Konten</span>
                ...
                <ul id="dropdown-example" class="hidden py-2 space-y-2">
                    <li>
                        <a href="#"
                            class="flex items-center w-full p-2 text-gray-900  transition duration-75 rounded-lg pl-11 group hover:bg-blue-400 dark:text-white dark:hover:bg-gray-700">Carousel</a>
                    </li>
                    <li>
                        <a href="#"
                            class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-blue-400 dark:text-white dark:hover:bg-gray-700">Ads</a>
                    </li>
                    <li>
                        <a href="#"
                            class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-blue-400 dark:text-white dark:hover:bg-gray-700">FAQ</a>
                    </li>
                </ul>
            </li>
        @endif

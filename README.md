...
```sh
git clone https://github.com/irfanarfianto/sargoy.git
```
...
The Sargoy project is a continuation of the Asfa Kasir project and licensed under the [MIT license](LICENSE).
